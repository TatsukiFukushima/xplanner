class SearchController < ApplicationController
  ...
  def result 
    ...
    @approaches = Approach.search(search: params[:search], effectiveness: params[:effectiveness], like_order: params[:like_count_p], comment_order: params[:comment_count_p]).paginate(page: params[:page], per_page: 10) if params[:approach_p] || params[:nav_a_p]
  end 
end
