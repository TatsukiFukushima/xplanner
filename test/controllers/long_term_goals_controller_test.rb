...
class LongTermGoalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should redirect create when not logged in" do 
    post user_long_term_goals_path(user_id: @user.id),
  ...
  test "should redirect edit when not logged in" do 
    get edit_user_long_term_goal_path(user_id: @long_term_goal_1.user_id, id: @long_term_goal_1.id)
    assert_not flash.empty?
    assert_redirected_to login_url 
  end 
  
  test "should redirect update when not logged in" do 
    patch user_long_term_goal_path(user_id: @long_term_goal_1.user_id, id: @long_term_goal_1.id),
  ...
  test "should redirect destroy when not logged in" do 
    delete user_long_term_goal_path(user_id: @long_term_goal_1.user_id, id: @long_term_goal_1.id)
    assert_not flash.empty?
    assert_redirected_to login_url 
  end
  ...
  test "should redirect create when logged in as wrong user" do 
    log_in_as(@other_user)
    post user_long_term_goals_path(user_id: @long_term_goal_1.user_id, id: @long_term_goal_1.id),
      params: { long_term_goal: { category: "Programming", content: "aiueoaiueo" } }
    assert flash.empty?
    assert_redirected_to root_url
  end  
